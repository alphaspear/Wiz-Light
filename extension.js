...
class MyPopup extends PanelMenu.Button {
  ...
  _init () {
    ...
    item_on.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/state.py",ipaddress,"on"]);
    ...
    item_off.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/state.py",ipaddress,"off"]);
...
///////////brightness control start//////////
    ...
    item_brightness_25.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/brightness.py",ipaddress,"25"]);
    ...
    item_brightness_50.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/brightness.py",ipaddress,"50"]);
    ...
    item_brightness_75.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/brightness.py",ipaddress,"75"]);
    ...
    item_brightness_100.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/brightness.py",ipaddress,"100"]);
...
//////////////color control ////start///////////
    ...
    item_color_white.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/color.py",ipaddress,"coolwhite"]);
    ...
    item_color_Warmwhite.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/color.py",ipaddress,"warmwhite"]);
        Main.notify(_('Color Changed To Warm White'));
    });
    ...
    item_color_red.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/color.py",ipaddress,"red"]);
    ...
    item_color_blue.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/color.py",ipaddress,"blue"]);
    ...
    item_color_green.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/color.py",ipaddress,"green"]);
    ...
    item_scene_party.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/scene.py",ipaddress,"4"]);
    ...
    item_scene_fireplace.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/scene.py",ipaddress,"5"]);
    ...
    item_scene_tvtime.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/scene.py",ipaddress,"18"]);
    ...
    item_scene_deepdive.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/scene.py",ipaddress,"23"]);
    ...
    item_scene_christmas.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/scene.py",ipaddress,"27"]);
    ...
    item_scene_halloween.connect('activate', () => {
        Util.spawn(["python3",".local/share/gnome-shell/extensions/wizlight@iabhilashjoshi/scene.py",ipaddress,"28"]);
